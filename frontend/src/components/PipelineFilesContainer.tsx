...
import {type PipelineDocument, type PipelineFilesContainerProps} from "../types/index"
import { getCurrentToken } from "../services/auth";
import { getPipelineDocuments } from "../services/document";
import { Box, Card, CardContent, CircularProgress, Grid, Typography } from "@mui/material";
import PictureAsPdfIcon from '@mui/icons-material/PictureAsPdf';

const PipelineFilesContainer: React.FC<PipelineFilesContainerProps> = ({user, pipeline}) => {
    ...
    return (
        ...
        >
            <Typography variant="h4" sx={{ mb: 4, fontWeight: 700, color: "#212121" }}>
